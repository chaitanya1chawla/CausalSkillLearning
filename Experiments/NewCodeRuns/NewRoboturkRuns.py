...
# Eval
python Master.py --train=0 --setting=learntsub --name=RT_001_eval_notrain_butsmoo --normalization=minmax --kl_weight=0.001 --subpolicy_ratio=1. --latentpolicy_ratio=0.0 --b_probability_factor=0.01 --data=Roboturk  --subpolicy_model=ExpWandbLogs/RTP_001/saved_models/Model_epoch500 --latent_loss_weight=0.0 --z_dimensions=16 --traj_length=-1 --var_skill_length=1 --training_phase_size=2000 --number_layers=4 --hidden_size=48 --var_number_layers=5 --var_hidden_size=48 --batch_size=32 --seed=0 --short_trajectories=1 --epsilon_from=0.3 --epsilon_to=0.01 --epsilon_over=100 --model=ExpWandbLogs/RT_001/saved_models/Model_epoch500 --dataset_traj_length_limit=100 --smoothen=1 --debug=1
...
# New joint runs
python Master.py --train=1 --setting=learntsub --name=RT_101 --normalization=minmax --kl_weight=0.001 --subpolicy_ratio=1. --latentpolicy_ratio=0.0 --b_probability_factor=0.01 --data=Roboturk  --subpolicy_model=ExpWandbLogs/RTP_201/saved_models/Model_epoch10 --latent_loss_weight=0.0 --z_dimensions=16 --traj_length=-1 --var_skill_length=1 --training_phase_size=2000 --number_layers=4 --hidden_size=48 --var_number_layers=5 --var_hidden_size=48 --batch_size=32 --seed=0 --short_trajectories=1 --epsilon_from=0.3 --epsilon_to=0.01 --epsilon_over=100 --epochs=5000 --datadir=/home/tshankar/Research/Code/Data/Datasets/Roboturk/ --smoothen=1

python Master.py --train=1 --setting=learntsub --name=RT_102 --normalization=minmax --kl_weight=0.001 --subpolicy_ratio=1. --latentpolicy_ratio=0.0 --b_probability_factor=0.01 --data=Roboturk  --subpolicy_model=ExpWandbLogs/RTP_202/saved_models/Model_epoch10 --latent_loss_weight=0.0 --z_dimensions=16 --traj_length=-1 --var_skill_length=1 --training_phase_size=2000 --number_layers=4 --hidden_size=48 --var_number_layers=5 --var_hidden_size=48 --batch_size=32 --seed=1 --short_trajectories=1 --epsilon_from=0.3 --epsilon_to=0.01 --epsilon_over=100 --epochs=5000 --datadir=/home/tshankar/Research/Code/Data/Datasets/Roboturk/ --smoothen=1

python Master.py --train=1 --setting=learntsub --name=RT_103 --normalization=minmax --kl_weight=0.001 --subpolicy_ratio=1. --latentpolicy_ratio=0.0 --b_probability_factor=0.01 --data=Roboturk  --subpolicy_model=ExpWandbLogs/RTP_203/saved_models/Model_epoch10 --latent_loss_weight=0.0 --z_dimensions=16 --traj_length=-1 --var_skill_length=1 --training_phase_size=2000 --number_layers=4 --hidden_size=48 --var_number_layers=5 --var_hidden_size=48 --batch_size=32 --seed=2 --short_trajectories=1 --epsilon_from=0.3 --epsilon_to=0.01 --epsilon_over=100 --epochs=5000 --datadir=/home/tshankar/Research/Code/Data/Datasets/Roboturk/ --smoothen=1
