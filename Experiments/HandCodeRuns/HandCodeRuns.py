...
// python Master.py --train=1 --setting=pretrain_sub --name=DAPG_Pretraining_100 --data=DAPG --kl_weight=0.001 --var_skill_length=1 --z_dimensions=16 --number_layers=8 --hidden_size=128 --save_freq=500 --normalization=minmax --viz_sim_rollout=0 