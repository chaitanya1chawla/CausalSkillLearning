...
# 
# Trying some stuff
python Master.py --train=1 --setting=pretrain_sub --name=RTP_debug --data=Roboturk --kl_weight=0.0001 --var_skill_length=1 --z_dimensions=16 --number_layers=4 --hidden_size=48 --batch_size=32 --normalization=minmax --no_mujoco=0 --seed=0 --epsilon_from=0.3 --epsilon_to=0.1 --epsilon_over=100 --display_freq=2000 --epochs=2000 --datadir=/home/tshankar/Research/Code/Data/Datasets/Roboturk/ 
...
python Master.py --train=1 --setting=pretrain_sub --name=RTP_300 --data=Roboturk --kl_weight=0.0001 --var_skill_length=1 --z_dimensions=16 --number_layers=4 --hidden_size=48 --batch_size=32 --normalization=minmax --no_mujoco=0 --seed=0 --epsilon_from=0.3 --epsilon_to=0.1 --epsilon_over=100 --display_freq=2000 --epochs=2000 --datadir=/home/tshankar/Research/Code/Data/Datasets/Roboturk/

# Eval
// python Master.py --train=0 --setting=pretrain_sub --name=RTP_300_orig --data=Roboturk --kl_weight=0.0001 --var_skill_length=1 --z_dimensions=16 --number_layers=4 --hidden_size=48 --batch_size=32 --normalization=minmax --no_mujoco=0 --seed=0 --epsilon_from=0.3 --epsilon_to=0.1 --epsilon_over=100 --display_freq=2000 --epochs=2000 --datadir=/home/tshankar/Research/Code/Data/Datasets/Roboturk/ --model=ExpWandbLogs/RTP_300/saved_models/Model_epoch80 --viz_sim_rollout=0

# 
python Master.py --train=1 --setting=pretrain_sub --name=RTP_300 --data=Roboturk --kl_weight=0.0001 --var_skill_length=1 --z_dimensions=16 --number_layers=4 --hidden_size=48 --batch_size=32 --normalization=minmax --no_mujoco=0 --seed=0 --epsilon_from=0.3 --epsilon_to=0.1 --epsilon_over=100 --display_freq=2000 --epochs=2000 --logdir=/home/tshankar/Research/Code/CausalSkillLearning/Experiments/TrainingLogs/ --z_dimensions=32 --split_stream_encoder=0 --datadir=/home/tshankar/Research/Data/Datasets/Roboturk/
